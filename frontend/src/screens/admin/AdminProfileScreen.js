...
const AdminProfileScreen = ({ auth, authLogin, authUpdateProfile, updateProfile, userLoaded }) => {
...
export default connect(mapStateToProps, { updateProfile, userLoaded })(AdminProfileScreen);