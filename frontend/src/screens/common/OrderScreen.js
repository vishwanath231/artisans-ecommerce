...
import { getOrderDetails, createRazorpayOrderAction, payOrder, orderDeliver } from '../../redux/actions/OrderActions';
...
const OrderScreen = () => {
    ...
    }, [orderId, order, authLogin, dispatch, navigate, info, successPay, successDeliver])
    ...
    return (
        <div className='bg-gray-100 min-h-screen'>
            ...
            <div className='my-5'>
                ...
                {
                    info.role === 'admin' ? 
                    <Link to='/admin/dashboard' className='px-5 py-3 hover:bg-gray-200 hover:text-[#DC143C] rounded text-sm font-medium tracking-wider'> Home</Link> : 
                    <Link to='/' className='px-5 py-3 hover:bg-gray-200 rounded text-sm font-medium tracking-wider'>Home</Link>
                }
